...
bashgit clone https://github.com/tu-usuario/Reto-Cicada-3301.git
cd Reto-Cicada-3301
...
Escanea el código QR para acceder a la página principal
Explora la terminal buscando elementos interactivos ocultos
Encuentra los 3 enlaces secretos (pista: usa la tecla H)
Completa los desafíos en cada plataforma externa
Captura screenshots de tus logros
Envía las evidencias para recibir tu premio
...
Next.js 15.5 - Framework de React
